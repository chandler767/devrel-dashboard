...
// (brew install yt-dlp). Pass withComments=true to also fetch comment text
// (slower; top 20 comments per video).
func YouTubeFetch(withComments bool) ([]internal.Video, error) {
	...
	return ytdlpFetch("youtube", shortsURL, withComments)
}
